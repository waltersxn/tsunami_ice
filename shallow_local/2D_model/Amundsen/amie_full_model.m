...
% plot_evecs, comment out everything after q = amie_Fullplate([] ...
...
mat_file_name = 'amie_ABq_bvar_tvar.mat'; %% adjust file name for properties
mat_only = 1; %% 1 to save only, 0 to continue simulation
